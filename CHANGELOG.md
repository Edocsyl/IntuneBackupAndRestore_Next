...
## [4.0.0] - 2024-02-22
Introdoucing Next version
- Added Function `Start-IntuneBackupTest` zum Testen
- Added Driver Update Rings. Function `Invoke-IntuneBackupWindowsDriverUpdateProfiles`
